      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-surface-DEFAULT border border-surface-border rounded-2xl p-6">
          ...
          <div className="mt-4 text-center text-sm text-text-muted">
            ...
            <p className="text-xs mt-1">Admin: <span className="text-violet-400">admin@ideaforge.app</span></p>
            <p className="text-xs">User: <span className="text-amber-400">user@ideaforge.app</span></p>
          </div>
        </div>
