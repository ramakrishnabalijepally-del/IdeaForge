...
- **AI Idea Generator** — Input any niche/keyword → Gemini 2.0 Flash generates a structured idea report (problem, solution, market, revenue model, feasibility score, competitive landscape, 5-step roadmap)
...
| Tool | Model | Role | Why |
|------|-------|------|-----|
| Gemini 2.0 Flash | `gemini-2.0-flash` | AI Idea Generator, RAG answer generation | Fast, cost-effective LLM for structured generation and grounded Q&A |
...
| AI | Google Gemini 2.0 Flash + Embedding via LangChain |
